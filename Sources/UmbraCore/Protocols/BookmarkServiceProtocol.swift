...
@objc
public protocol BookmarkServiceProtocol: NSObjectProtocol {
    ...
    @objc
    func startAccessing(_ url: URL, error: NSErrorPointer) -> Bool
    ...
    @objc
    func validateBookmark(_ bookmark: Data, error: NSErrorPointer) -> Bool
